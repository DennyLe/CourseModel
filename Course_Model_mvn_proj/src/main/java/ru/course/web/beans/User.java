...
public class User implements Serializable {
    ...
    public String login() {
        ...
        try {
            ...
            return "/pages/courses.xhtml?faces-redirect=true";
        } catch (ServletException ex) {

            ResourceBundle bundle = ResourceBundle.getBundle("ru.courses.web.nls.messages", FacesContext.getCurrentInstance().getViewRoot().getLocale());
